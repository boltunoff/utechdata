...
class UsBusinessDatabaseSample(models.Model):
    ...
    c23 = models.TextField(blank=True, null=True)
    c24 = models.TextField(blank=True, null=True)
    c25 = models.TextField(blank=True, null=True)
    c26 = models.TextField(blank=True, null=True)
    c27 = models.TextField(blank=True, null=True)
    c28 = models.TextField(blank=True, null=True)
    c29 = models.TextField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'us_business_database_sample'
